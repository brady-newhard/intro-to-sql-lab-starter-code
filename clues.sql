...
SELECT * FROM countrylanguages WHERE countrycode = 'VAT' AND isofficial = true;
...
SELECT * FROM cities WHERE countrycode IN (SELECT code FROM countries WHERE region = 'South America') AND name LIKE 'Serra%';

-- Clue #6: We're close! Our South American agent says she just got a taxi at the airport, and is headed towards
-- the capital! Look up the country's capital, and get there pronto! Send us the name of where you're headed and we'll
-- follow right behind you!

SELECT * FROM cities WHERE id = (SELECT capital FROM countries WHERE code = 'BRA');
